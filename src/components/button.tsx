...
export default function Button(
    ...
    disabled,
    size
}: { onClick?: () => void; children: React.ReactNode; to?: string; type?: "button" | "submit"; secondary?: boolean; disabled?: boolean; size?: "sm" | "md" | "lg" }) {
