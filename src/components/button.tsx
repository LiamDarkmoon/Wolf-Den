...
export default function Button(
    ...
    return (
        ...
        <button type={type ?? "button"} onClick={() => handleNavigate(to)}  className={`group relative flex items-center justify-center ${secondary ? "text-main-text" : "text-primary"} transition-transform duration-200 ease-in-out`}>
