...
export default function Button(
    ...
    secondary,
    size
}: { onClick?: () => void; children: React.ReactNode; to?: string; type?: "button" | "submit"; secondary?: boolean; size?: "sm" | "md" | "lg" }) {
    ...
    return (
        ...
        <button type={type ?? "button"} onClick={onClick || (() => handleNavigate(to))}  className={`group relative flex items-center justify-center cursor-pointer ${secondary ? "text-main-text" : "text-primary"} transition-transform duration-200 ease-in-out`}>
