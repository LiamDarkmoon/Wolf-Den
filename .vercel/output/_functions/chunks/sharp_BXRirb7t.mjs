import { A as AstroError, N as NoImageMetadata, i as UnsupportedImageFormat, h as MissingSharp } from './entrypoint_C39tklsY.mjs';
import { b as baseService, d as detector, r as resolveDefaultOutputFormat, p as parseQuality } from './generic_DA6vwwYI.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_CMRQBOaO.mjs').then(n => n.i)).default;
  } catch {
